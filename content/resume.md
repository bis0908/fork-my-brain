...
- **2022년 개발자 전환 후 3년 6개월의 집중적인 성장**을 통해 Node.js 기반 풀스택 개발 역량을 구축해왔습니다. 일반적인 개발자 커리어 대비 상대적으로 짧은 기간이지만, 그 이전 9년간의 시스템 엔지니어링 경험이 개발자로서의 차별화된 기반이 되고 있습니다.
- **비개발 분야에서의 기술적 토대**: 발전소 CMMS 구축, 진동측정장비 소프트웨어 엔지니어링, 웹서비스 QA 등을 통해 **시스템 전체를 조망하는 관점**과 **24/7 안정성에 대한 실무적 이해**를 먼저 갖춘 후 개발에 입문했습니다.
- **압축적이지만 밀도 높은 개발 경험**: 대학 입시 컨설팅 사이트, 시간당 1,200건 처리하는 인플루언서 마케팅 플랫폼, WebRTC n:m 강의 시스템 등 다양한 복잡도의 프로젝트를 성공적으로 수행하며 **실전 중심의 빠른 성장**을 이뤄왔습니다.
- **늦은 시작의 역설적 장점**: 해외 프로젝트(인도, 말레이시아, 일본, 독일) 및 산업용 시스템 운영 경험에서 체득한 **클라이언트 중심적 사고**와 **장기적 유지보수성에 대한 깊은 이해**를 자연스럽게 코드 설계에 반영하고 있습니다. 이는 순수 개발자 출신과 구별되는 독특한 강점입니다.
- 기본적으로 **읽기 편한 코드를 지향**하며, **견고하고 확장성 있는 설계**를 통해 안정적인 시스템 구축에 중점을 두고 있습니다. 프론트엔드부터 백엔드까지 전체 개발 과정을 아우르는 풀스택 역량과 함께, 기술적 요구사항을 이해하고 클라이언트 중심의 솔루션을 제공합니다.
