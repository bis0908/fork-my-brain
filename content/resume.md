...
- **다양한 산업 경험을 바탕으로 한 개발자**로, 시스템 엔지니어링과 품질관리 분야에서 9년간 쌓은 기술적 기반을 토대로 2022년 본격적인 개발자 전환을 이뤘습니다.
- 발전소 설비 관리 시스템(CMMS), 진동측정장비 소프트웨어 엔지니어링, 웹서비스 QA 등의 경험을 통해 **시스템 전체를 바라보는 관점**과 **안정성에 대한 깊은 이해**를 개발 역량의 기반으로 삼고 있습니다.
- 현재는 Node.js 기반 풀스택 개발자로서 대학 입시 컨설팅, 인플루언서 마케팅 플랫폼, WebRTC 강의 시스템 등 다양한 프로젝트를 성공적으로 수행하고 있습니다.
- **늦은 시작이지만 탄탄한 기술적 기반**: 비개발 분야에서의 시스템 운영 경험이 개발 시 **견고하고 확장성 있는 설계**를 자연스럽게 추구하게 만들었으며, 24/7 기술지원과 해외 프로젝트 경험을 통해 **클라이언트 중심의 솔루션 제공**에 대한 깊은 이해를 갖추고 있습니다.
- 기본적으로 **읽기 편한 코드를 지향**하며, 장기적인 유지보수성을 고려한 시스템 설계 경험을 바탕으로 프론트엔드부터 백엔드까지 전체 개발 과정을 아우르는 풀스택 개발 능력을 발휘하고 있습니다.
